...
app = FastAPI(
    ...
    description="Multi-agent governance command center API for enterprise approval, policy, audit, and report workflows.",
    version="1.0.0",
)
        ...
        "agent_findings": [
            {
                "agent": "Request Intake Agent",
                "status": "completed",
                "finding": "Request normalized and routed to review workflow.",
            },
            {
                "agent": "Policy Review Agent",
                "status": "completed",
                "finding": "DP-03 policy restricts raw customer email export.",
            },
            {
                "agent": "Permission Agent",
                "status": "completed",
                "finding": "Requester role does not have required permission.",
            },
            {
                "agent": "Data Sensitivity Agent",
                "status": "completed",
                "finding": "Customer emails are classified as PII.",
            },
            {
                "agent": "Security Risk Agent",
                "status": "completed",
                "finding": "Risk score is 85/100. High risk.",
            },
            {
                "agent": "Human Escalation Agent",
                "status": "completed",
                "finding": "Human approval required for exception.",
            },
            {
                "agent": "Final Decision Agent",
                "status": "completed",
                "finding": "Raw export rejected. Safe alternative recommended.",
            },
            {
                "agent": "Audit Evidence Agent",
                "status": "completed",
                "finding": "Audit evidence package generated.",
            },
        ],
        "final_decision": {
            "decision": "Rejected",
            "risk": "High",
            "reason": "Role mismatch + sensitive PII data + policy restriction",
            "safe_alternative": "Provide anonymized audience report",
            "audit_ready": True,
        },
    }
